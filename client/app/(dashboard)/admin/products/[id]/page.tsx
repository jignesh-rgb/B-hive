...
const DashboardProductDetails = ({ params }: DashboardProductDetailsProps) => {
    ...
    const updateProduct = async () => {
        if (
            ...
            toast.error("You need to enter values in all required input fields");
            return;
        }
    ...
    const uploadFile = async (file: any) => {
        ...
        try {
            ...
            setProduct({ ...product!, mainImage: response.data.imageUrl });
    ...
    const fetchProductData = async () => {
        try {
            ...
            // Normalize categoryId to string if it's an object
            if (productData.categoryId && typeof productData.categoryId === 'object') {
                productData.categoryId = productData.categoryId.id;
            }
            
            setProduct(productData);

            // Fetch images
            const imagesResponse = await apiClient.get(`/api/images/${id}`);
            setOtherImages(imagesResponse.data);
